                    ...
                    Route::group(['middleware' => 'api.check.attendee.exists'], function () {
                        Route::prefix('attendee/{attendeeId}')->group(function () {
                            ...
                            Route::get('test-notification', function(){
                                sendPushNotification("f40ank7QRb-bpfBh9SG2Qn:APA91bH9mtupEBCj1s5k9alPKl3DRU7tWLvJyNjDGb2jGhb9ShclHzLzaqsI66utvQdfbAwFsQ8rnPjRptX_nuU1vPNRpimfucL6FnPgL1_emuCD5GR3HI-0ZqsHFiM7x1zkYI4_r9Qc", "Test title", "Test message", null);
                            });
