                ...
                Route::middleware("auth:sanctum")->group(function () {
                    Route::group(['middleware' => 'api.check.attendee.exists'], function () {
                        Route::prefix('attendee/{attendeeId}')->group(function () {
                            ...
                            Route::get('/v2/homepage', [EventController::class, 'apiEventHomepagev2']);
                            ...
                            Route::post('/send-chat-push-notification', [AttendeesController::class, 'sendChatPushNotification']);
