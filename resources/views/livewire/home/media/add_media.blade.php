            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="mt-5 ">
                        ...
                        <div class="mt-2">
                            <input type="file" wire:model.lazy="mediaFile"
                                class="bg-registrationInputFieldsBGColor w-full py-1 px-3 outline-primaryColor">
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button type="button"
                        ...
                        wire:click.prevent="addMediaConfirmation">Add</button>
                    <button type="button"
                        ...
                        wire:click.prevent="cancelAddMedia">Cancel</button>
                </div>
            </div>
        </div>
    </form>
