                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="space-y-2 col-span-2 grid grid-cols-2 gap-5 items-start mt-5">
                        <div class="col-span-2 mt-2">
                            <div class="text-primaryColor">
                                Floor plan 3d image link
                            </div>
                            <div class="mt-2">
                                <input placeholder="https://gpca.org.ae/conferences/anc/3d-image.jpg/" type="text" wire:model.lazy="floor_plan_3d_image_link" class="bg-registrationInputFieldsBGColor w-full py-1 px-3 outline-primaryColor rounded-md border border-gray-200">
                            </div>
                        </div>

                        <div class="col-span-2 mt-2">
                            <div class="text-primaryColor">
                                Floor plan exhibition image link
                            </div>
                            <div class="mt-2">
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse mt-5">
                        <button type="button"
                            ...
                            wire:click.prevent="editEventFloorPlanLinksConfirmation">Update</button>
                        <button type="button"
                            ...
                            wire:click.prevent="resetEditEventFloorPlanLinksFields">Cancel</button>
                    </div>
                </div>
            </div>
    </form>
