                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                        <button type="button"
                            ...
                            wire:click.prevent="editFeatureDateTime">Update</button>
                        <button type="button"
                            ...
                            wire:click.prevent="cancelEditFeatureDateTime">Cancel</button>
                    </div>
                </div>
            </div>
    </form>
