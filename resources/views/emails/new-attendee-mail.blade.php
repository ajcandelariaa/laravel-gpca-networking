...
<p class="normal" style="margin-top: 15px;">We are excited to welcome you to the <strong>{{ $details['eventName'] }}</strong> in Riyadh and ensure a rewarding and engaging conference experience.</p>
